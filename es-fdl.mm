...
<node COLOR="#cc3300" CREATED="1387299242489" ID="ID_648842869" MODIFIED="1387300035510" TEXT="Coupling Technology">
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      Should the top-level concept be &quot;Coupling Technology&quot; or &quot;Earth System Framework?&quot;
    </p>
    <ul>
      <li>
        the former implies the software is used for coupling (i.e., may not be helpful for standalone model)
      </li>
      <li>
        the latter implies a framework, which carries technical connotations of having a predefined architecture and calls back to use code
      </li>
    </ul>
  </body>
</html>
